...
/**
 * Direkte Test-Seite für das Mall-Template
 * 
 * Diese Seite testet das Mall-Template mit statischen XML-Daten,
 * um Probleme mit dem Streaming zu umgehen.
 */
export default function MallDirectTestPage() {
  const [isStreaming, setIsStreaming] = useState(false);
  const [isComplete, setIsComplete] = useState(true);
  
  // Statischer XML-Inhalt für den Test
...
Tipp: Besuchen Sie mehrere Shops, um die perfekte Hose zu finden. Viele Geschäfte bieten kostenlose Anproben und Größenberatung an!
  ...
  return (
    <div style={{ 
      ...
      <h1>Mall-Template Direkter Test</h1>
      <p>Diese Seite testet das Mall-Template mit statischen XML-Daten.</p>
