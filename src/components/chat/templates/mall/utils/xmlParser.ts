 ...
 */
function extractOpeningHoursFromXml(content: string): any {
 ...
 */
function extractEventsFromXml(content: string): any[] {
  if (!content) return [];
 ...
 */
function extractParkingFromXml(content: string): any {
  if (!content) return null;
