...
interface OptimizedShopCardProps {
  data: ShopData;
...
/**
 * Eine hochoptimierte Shop-Karte mit stabilem Rendering
 ...
 */
const OptimizedShopCard: React.FC<OptimizedShopCardProps> = ({
  data,
  style = {},
  isLoaded = true
}) => {
  ...
  const cardStyle = useMemo<React.CSSProperties>(() => ({
    ...
    willChange: 'opacity', // Optimierung für Animationen
  ...
  const categoryStyle = useMemo<React.CSSProperties>(() => ({
    fontSize: '0.9rem',
    color: '#555',
    margin: '0 0 0.5rem 0',
    display: 'flex',
  ...
  const openingStyle = useMemo<React.CSSProperties>(() => ({
    fontSize: '0.85rem',
    color: '#555',
    margin: '0.5rem 0',
    display: 'flex',
...
export default React.memo(OptimizedShopCard);
