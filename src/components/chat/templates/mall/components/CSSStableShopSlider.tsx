...
import CSSStableShopCard from './CSSStableShopCard';

interface CSSStableShopSliderProps {
  title: string;
  shops: ShopData[];
...
/**
 * Eine CSS-basierte stabile Version des Shop-Sliders, die während des Streamings nicht flackert
 * und ein konsistentes Layout beibehält
 */
const CSSStableShopSlider: React.FC<CSSStableShopSliderProps> = ({
  title,
  shops,
  style = {},
  isStreaming = false
  ...
  return (
    <div className="stable-slider-container" style={style}>
      <h2 className="stable-slider-title">{title}</h2>
      ...
      <div className="stable-slider-content">
        ...
        {showLeftArrow && (
          <button
            onClick={scrollPrev}
            className="stable-slider-arrow stable-slider-arrow-left"
        ...
        {showRightArrow && (
          <button
            onClick={scrollNext}
            className="stable-slider-arrow stable-slider-arrow-right"
...
export default CSSStableShopSlider;
