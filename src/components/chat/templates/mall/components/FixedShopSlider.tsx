...
interface FixedShopSliderProps {
  title: string;
  shops: ShopData[];
...
/**
 * Eine vollständig überarbeitete Shop-Slider-Komponente mit festem Layout
 */
const FixedShopSlider: React.FC<FixedShopSliderProps> = ({
  title,
  shops,
  style = {},
  isStreaming = false
...
export default FixedShopSlider;
